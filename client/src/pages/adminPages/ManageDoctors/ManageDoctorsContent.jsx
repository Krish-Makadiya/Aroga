...
import {
    UserCircle, // Lucide-react or heroicons
    Mail,
    Phone,
    FileText,
    BadgeCheck,
...
const DoctorCard = ({ doctor, onDocView, onVerify, isVerifying }) => (
        ...
        <div className="flex flex-wrap gap-2 mt-2">
            ...
            {onVerify && (
                <button
                    ...
                    className="inline-flex items-center px-5 py-2 bg-green-600 dark:bg-green-700 text-white rounded hover:bg-green-700 dark:hover:bg-green-800 transition gap-2 font-medium mt-1 disabled:opacity-50 disabled:cursor-not-allowed">
                    {isVerifying ? (
                        <>
                        ...
                        <>
                            <CheckCircle2 className="w-4 h-4" /> Verify Doctor
                        </>
                    )}
                </button>
            )}
        ...
        <div className="p-6 bg-light-bg dark:bg-dark-bg min-h-screen">
            ...
            {doctors.length === 0 ? (
                <div className="text-center py-12 text-light-secondary-text dark:text-dark-secondary-text">
                    <p className="text-lg">No pending doctors to verify.</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-7">
                    {doctors.map((doctor) => (
                        <DoctorCard
                            ...
                            isVerifying={verifyingId === doctor._id}
                        />
                    ))}
                </div>
            )}
...
export default ManageDoctorsContent;
